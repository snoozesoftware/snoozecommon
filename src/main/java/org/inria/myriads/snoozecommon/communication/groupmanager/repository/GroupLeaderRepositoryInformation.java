 ...
 * @author Eugen Feller
 */
public final class GroupLeaderRepositoryInformation 
    implements Serializable
{
    /** Default serial. */
    private static final long serialVersionUID = 1L;
    
    /** Descriptions of the group managers. */
    private ArrayList<GroupManagerDescription> groupManagerDescriptions_;
     ...
     */
    public void setGroupManagerDescriptions(ArrayList<GroupManagerDescription> groupManagers) 
    {
        groupManagerDescriptions_ = groupManagers;
    }
    ...
    {
        return groupManagerDescriptions_;
    }
}
